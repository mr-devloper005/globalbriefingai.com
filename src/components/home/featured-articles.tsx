          ...
          {hero && (
            ...
            >
              <div className="relative aspect-[16/9] overflow-hidden">
                <Image
                  src={hero.coverImage || 'https://img.freepik.com/free-photo/business-team-analyzing-data_23-2148826808.jpg'}
                  alt={hero.title}
                  fill
          ...
          <div className="grid gap-6">
            {[second, third].filter(Boolean).map((article) => (
              ...
              >
                <div className="relative aspect-[16/9] overflow-hidden">
                  <Image
                    src={article!.coverImage || 'https://img.freepik.com/free-photo/confident-business-team-with-leader_1098-3228.jpg'}
                    alt={article!.title}
                    fill
